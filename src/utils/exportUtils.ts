...
export const exportarRelatorioPDF = (
  ...
  doc.text('STOCKPRO - RELATÓRIO DE ANÁLISE', 20, 30)
  
  doc.setFontSize(12)
  doc.setTextColor(255, 255, 255)
  doc.text(`Período: ${estatisticas.periodoTexto}`, 20, 37)
  ...
  yPosition += 8
  doc.text(`Lucro Líquido: R\$ ${estatisticas.lucroReal.toFixed(2)}`, 25, yPosition)
  yPosition += 8
  ...
  doc.text(`Número de Vendas: ${estatisticas.numeroVendas}`, 25, yPosition)
  yPosition += 8
  ...
  doc.setFontSize(16)
  doc.text('SITUAÇÃO DO ESTOQUE', 20, yPosition)
  yPosition += 15
